      ...
      <main className="col-span-4 p-4">
        <nav className="w-full flex items-center justify-between">
          <div className="flex items-center text-gray-600 text-sm gap-1">
            <span className="font-semibold pl-1">Monday,</span><span>February  3</span>
          </div>
          <button onMouseEnter={} className="flex items-center gap-1 cursor-pointer">
            <img src={profileIcon} className="w-10 h-10 rounded-full border-3 border-gray-100" alt="user_icon" />
            <span className="text-sm text-gray-600 font-medium hover:text-[#2BACDE]">Vansh Kumar</span>
